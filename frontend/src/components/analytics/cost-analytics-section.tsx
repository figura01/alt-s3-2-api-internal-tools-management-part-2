...
export function CostAnalyticsSection({ data }: Props) {
  const spendEvolution = [
    {
      month: "Previous",
      spend: data.analytics.budget_overview.previous_month_total,
    },
    {
      month: "Current",
      spend: data.analytics.budget_overview.current_month_total,
    },
  ];
