...
function PageContent() {
  const query = useQuery({ queryKey: ["tools", "page"], queryFn: () => Promise.all([getTools(), getDepartments(), getCategories()]) });
  ...
  const [toolsResponse, departments, categories] = query.data;
...
export default function ToolsPage() { return <AccessGate><PageContent /></AccessGate>; }
